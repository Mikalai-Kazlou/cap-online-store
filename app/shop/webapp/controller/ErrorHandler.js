sap.ui.define(
  ['sap/ui/base/Object', 'sap/m/MessageBox', 'sap/ui/model/Filter', 'sap/ui/model/FilterOperator'],
  function (UI5Object, MessageBox, Filter, FilterOperator) {
    'use strict';

    return UI5Object.extend('ns.shop.controller.ErrorHandler', {
      /**
       * Handles application errors by automatically attaching to the model events and displaying errors when needed.
       * @class
       * @param {sap.ui.core.UIComponent} oComponent reference to the app's component
       * @public
       * @alias ns.shop.controller.ErrorHandler
       */
